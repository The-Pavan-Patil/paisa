...
import { updateDefaultSalaryTemplate, updateEmployerName, updateUserName } from "@/app/actions/profile";
    ...
    <div className="space-y-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-3 text-xs">
          <div className="text-zinc-700">Email: {profile?.email ?? user.email}</div>
      ...
      <Card>
        ...
        <CardContent>
          <form action={updateEmployerName} className="space-y-2 text-xs">
            ...
            <p className="text-xs text-zinc-500">Used to classify NEFT / IMPS / UPI credits as salary when the text matches.</p>
          </form>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <form action={updateDefaultSalaryTemplate} className="space-y-2 text-xs">
            ...
            <p className="text-xs text-zinc-500">Prefill for future months can be wired to Monthly Entry.</p>
          </form>
        </CardContent>
      </Card>
